""""
小论文 敏感性分析
A07后偏转段机架敏感性分析之全部CCT纵向error.py
"""
        ...
        for cct in allcct:
            ...
            bl.magnets.append(CCT.create_by_existing_cct(
                ...
                starting_point_in_ksi_phi_coordinate = 
                    cct.starting_point_in_ksi_phi_coordinate + P2(y = error / cct.big_r),
                end_point_in_ksi_phi_coordinate = 
                    cct.end_point_in_ksi_phi_coordinate + P2(y = error / cct.big_r)
            ))
        bls.append(bl)
