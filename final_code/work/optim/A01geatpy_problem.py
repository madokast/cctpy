import geatpy as ea
from work.optim.A01run import run
...
class Myproblem(ea.Problem):
    def __init__(self):
        ...
        Dim = 16  # 变量维度
        varTypes = ([0] * 12) + ([1] * 2) + ([0] * 2)  # 变量类型浮点/整数, [0] for real number , [1] for integer
        # 变量最小值
        lb = [-10, -10, -100, -100,    60, 60, 80,      60, 60, 80, -15000, 4000,15,15,-10,-10]
        ...
        # 变量最大值
        ub = [10,  10,   100,  100,  120, 120, 100, 120, 120, 100, -6000, 16000,   25,25,10,10]
