import geatpy as ea
from optimization.run_first_bending_part import run
...
class Myproblem(ea.Problem):
    def __init__(self):
        ...
        # 变量最小值
        lb = [-8, -13, -127, -72,    60, 60, 80,      60, 60, 80, -12000, 6000,15,15]
        ...
        # 变量最大值
        ub = [8,  13,   127,  72,  120, 120, 100, 120, 120, 100, -8000, 14000,   25,25]
